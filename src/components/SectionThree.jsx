...
export default function SectionThree() {
  ...
  const items = [
    ...
    { type: "image", src: "/assets/hp-sec2/5.webp", title: "Helicopter Flight & Fine Dining", desc: "A 30-minute scenic flight followed by a fine-dining lunch." },
    { type: "image", src: "/assets/hp-sec2/6.webp", title: "Maxwell Maze & Picnic", desc: "Relax with wine while the kids explore the maze." },
  ];
